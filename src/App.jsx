    ...
    <div className="App">
      <div className='bg-blue-300 h-screen flex items-center justify-center'>
        <div className="max-w-xl rounded-xl bg-blue-200 py-10 px-10 text-center shadow-2xl relative">
          ...
          <button onClick={() => getAdvice()} className={`${loading ? 'blur-sm' : 'blur-none'} hover:shadow-shadow absolute -bottom-8 right-2/4 translate-x-2/4 h-16 w-16 rounded-full bg-green flex items-center justify-center`}>
            <img src={cube} alt="" />
          </button>
        </div>
      </div>
